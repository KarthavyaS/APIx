        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
          ...
          <div className="p-4 bg-slate-50 rounded-xl border border-slate-200 space-y-2">
            ...
            <div className="text-xs text-slate-700 leading-relaxed">
              <strong className="block text-slate-900">National Statistical Office (NSO)</strong>
          ...
          <div className="p-4 bg-slate-50 rounded-xl border border-slate-200 space-y-2">
            ...
            <div className="text-xs text-slate-700 space-y-1">
              <div>
                <span className="text-[10px] text-slate-500 block uppercase font-bold">CPI & Airfare Data:</span>
                <a href="mailto:cpi-nso@mospi.gov.in" className="text-indigo-600 hover:underline font-mono">cpi-nso@mospi.gov.in</a>
              </div>
              <div>
                <span className="text-[10px] text-slate-500 block uppercase font-bold">Public Statistics Cell:</span>
                <a href="mailto:apix-support@mospi.gov.in" className="text-indigo-600 hover:underline font-mono">apix-support@mospi.gov.in</a>
              </div>
            </div>
          </div>
          ...
          <div className="p-4 bg-slate-50 rounded-xl border border-slate-200 space-y-2">
            ...
            <div className="text-xs text-slate-700 space-y-1">
              <div>
                <span className="text-[10px] text-slate-500 block uppercase font-bold">MoSPI EPABX:</span>
                <span className="font-mono text-slate-800">+91 (11) 2374 2100</span>
              </div>
              <div>
                <span className="text-[10px] text-slate-500 block uppercase font-bold">National Consumer Helpline:</span>
                <span className="font-mono text-emerald-700 font-bold">1915 (Toll-Free)</span>
              </div>
            </div>
          </div>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full text-xs p-2.5 rounded-lg border border-slate-300 focus:ring-2 focus:ring-indigo-500 focus:outline-none bg-white cursor-pointer"
                >
          ...
          <div className="bg-slate-50 p-5 rounded-xl border border-slate-200 space-y-3">
            ...
            <div className="space-y-2 text-xs">
              <a
                ...
                className="p-2.5 bg-white rounded-lg border border-slate-200 hover:border-indigo-300 hover:text-indigo-600 transition flex justify-between items-center font-medium text-slate-700"
              >
